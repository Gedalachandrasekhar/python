...
c
{'A': 65}
#WAP to check whether a character is in the uppercase or not. If the uppercase, store the value inside the dictionary (key as a character and value as an ascii value).
a='A'
b=ord(a)
c={a:b}
if  'A'<a<'Z':
...
c
{'A': 65}
#WAP to check whether a character is in the uppercase or not. If the uppercase, convert to lowercase and store the value inside the dictionary (character as a key and asciivalue as a value).
